//Concepts used: Inheritance, Access  Specifiers, Inline functions
...
class SickMealPreparation : public MealManagement {
public:
...
public:
    void enterSickMealDetails();

};
inline void SickMealPreparation::enterSickMealDetails(){
	    string isSick;
...
int main() 
{
    ...
    SickMealPreparation sickMeal;
    sickMeal.enterSickMealDetails();
